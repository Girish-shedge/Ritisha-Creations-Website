import svgPaths from "./svg-p6gszerxkz";
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[40px] items-center justify-center left-[16px] top-[-304px] w-[361px]">
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 absolute bg-gradient-to-t content-stretch flex from-[12.393%] from-black h-[44px] items-center justify-center left-1/2 overflow-clip px-[16px] py-[12px] rounded-[62px] to-[#333] top-[16px] w-[362px]">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Season_Mix-TRIAL:SemiBold',sans-serif] leading-[normal] min-w-px not-italic relative text-[16px] text-center text-white tracking-[-0.16px]">Go Back</p>
    </div>
  );
}

export default function Screen2Scrolled() {
  return (
    <div className="bg-white relative size-full" data-name="Screen 2 Scrolled">
